...
@section('content')
    <div class="container">
        ...
        <div class="card shadow-sm border-0 rounded-3">
            ...
            <div class="card-body">
                <form
                    action="{{ isset($student) ? route($authUser->role . '.students.update', $student->id) : route($authUser->role . '.students.store') }}"
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Trạng thái + Ghi chú trên cùng dòng --}}
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="note" class="form-control" rows="1">{{ old('note', $student->note ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route($authUser->role . '.students.index') }}" class="btn btn-secondary px-4">
                            Quay lại
                        </a>
                    </div>
                </form>
