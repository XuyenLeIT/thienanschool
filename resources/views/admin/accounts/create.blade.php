...
<script>
    ...
    // Loading khi submit form ban
    var banForm = document.getElementById('banForm');
    var banBtn = document.getElementById('banSubmitBtn');
    banForm.addEventListener('submit', function() {
        banBtn.disabled = true;
        banBtn.querySelector('.btn-text').textContent = "Đang xử lý...";
        banBtn.querySelector('.loading-spinner').style.display = "inline-block";
    });
</script>
@endsection
