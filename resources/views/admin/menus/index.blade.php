...
@section('content')
    <style>
        ...
        #previewLayout {
            ...
            overflow: hidden;
            /* tránh phần tử tràn ra ngoài */
        }

        /* 🔥 Overlay tiêu đề */
        .overlay-text-top {
            background: rgba(0, 0, 0, 0.6);
            /* Nền mờ để chữ nổi bật */
            padding: 15px 30px;
            border-radius: 12px;
            display: inline-block;
            /* Gói gọn theo nội dung */
            text-align: center;
            color: #fff;
    ...
    <div class="container py-4">
        ...
        <div class="alert alert-info mt-3">
            <strong>Lưu ý:</strong> Thực đơn có thể thay đổi theo tuần. Vui lòng kiểm tra và cập nhật thường xuyên để đảm
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('exportImageBtn').addEventListener('click', async () => {
                ...
                document.querySelectorAll('.no-export').forEach(el => el.classList.add(
                    'hide-during-export'));
                ...
                try {
                    ...
                    document.querySelectorAll('.no-export').forEach(el => el.classList.remove(
                        'hide-during-export'));
                }
            });
        });
