                ...
                @php
                    ...
                    if ($role === 'teacher') {
                        ...
                        $menus = [
                            ...
                            [
                                'route' => 'manager.daily_schedules.index',
                                'icon' => 'fa-calendar-day',
                                'label' => 'Daily Schedules',
                            ],
                            ['route' => 'manager.tuition.index', 'icon' => 'fa-money-bill', 'label' => 'Học phí'],
                            [
                                'route' => 'manager.registrations.index',
                        ...
                        $menus = [
                            ...
                            [
                                'route' => 'admin.parent_notices.index',
